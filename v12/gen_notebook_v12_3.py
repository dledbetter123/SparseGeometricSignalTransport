"""Generate architecture_v12_3.ipynb — Spectral-Native Architecture.
The model LIVES in spectral domain. SSM and MLP operate on spectral coordinates.
Spatial only exists at the decoder. No domain round-trips inside blocks."""
import json
import os
...
# ═══════════════════════════════════════════════════════════════
# CELL 7: SpectralSSM (operates on spectral coordinates)
# ═══════════════════════════════════════════════════════════════
code(
...
# ═══════════════════════════════════════════════════════════════
# CELL 8: SpectralInteraction (cross-mode + cross-subbundle)
# ═══════════════════════════════════════════════════════════════
code(
...
# ═══════════════════════════════════════════════════════════════
# CELL 12: V12_3Model + GPT + SSM baselines + instantiate
# ═══════════════════════════════════════════════════════════════
code(
...
# ═══════════════════════════════════════════════════════════════
code("v12_hist = train_model(model, config, label='V12.3')")
...
# ═══════════════════════════════════════════════════════════════
md("## Diagnostics: Is Spectral Domain Active?")
...
outpath = os.path.join(os.path.dirname(os.path.abspath(__file__)), "architecture_v12_3.ipynb")
